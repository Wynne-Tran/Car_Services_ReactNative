...
const View_Submission = ({navigation}) => {
        ...
        const unsubscribe = navigation.addListener('focus', () => {
            ...
            const countService = async() => {
                ...
                const events = data2.map(e => ({
                  ...
                  location: e.address, 
                  color: (e.mod_approval == "" ? 'rgba(241, 153, 40, 1)' : 
                            (e.status == "" ? 'rgba(255, 111, 199, 1)' : 'rgba(102, 204, 255, 1)'))
                }))
        ...
        <ImageBackground source={require('../../../assets/images/plainBg.png')}  style={styles.background}>
            <View style = {styles.container}>
                ...
                <View style={styles.calendar}>
                  <TimeTable
                    events={eventGroups}
                    eventOnPress={(event) => navigation.navigate("Approve_Submission", {id: event.section})}
