...
const Edit_Profile = ({navigation}) => {
    ...
    const updateUser = async(id, fullname, address, getImageUrl, jobTitle, experience, salary) => {
        ...
        const newFields = {
            ...
            salary: salary,
            password: users.password, 
            activeMechanic: users.activeMechanic == "Yes" ? "Yes" : "No"
        }
    ...
    return (
        <ImageBackground source={require('../../../assets/images/Background.png')}  style={styles.background}>
            <View style = {styles.container}>
                ...
                <Formik 
                    initialValues = {{fullname: '',address: '', jobTitle:'', experience:'', salary: ''}}
                    onSubmit = {(value)=>{
                        console.log(value)
                        updateUser(users.id, value.fullname, value.address, users.image, value.jobTitle, value.experience, value.salary)
                        navigation.goBack() }}
                    >
                    { (props)=>(
                        <View>
