                    ...
                    <View>
                        ...
                        <View style={{alignItems: 'center'}}>
                            <Text style = {{color: colors.text_white, fontSize:18, marginTop: 10, marginHorizontal: 10}}>
                                You served <Text style={{fontSize: 25, fontWeight: 'bold', color:'red'}}>0</Text> customers !
                            </Text>
                        </View>
                    </View>
                    ...
                    <ScrollView style={{padding: 10}}>
                        ...
                        {users.activeMechanic == "Yes" && (
                            ...
                            <ImageBackground source={require('../../../assets/images/green_note.png')}  style={styles.background2}>
                                <Text style={{color: colors.text_white, fontWeight: 'bold', marginLeft: '20%', fontSize: 18}}>Congratualtion! You can find your task now !</Text>
                            </ImageBackground>
                        </View>
                        )}
