...
const Edit_Profile = ({navigation}) => {
    ...
    const updateUser = async(id, fullname, address, getImageUrl, jobTitle, vehicle) => {
    ...
    return (
        <ImageBackground source={require('../../../assets/images/Background.png')}  style={styles.background}>
            <View style = {styles.container}>
                ...
                <Formik 
                    initialValues = {{fullname: '',address: '', jobTitle:'', vehicle:''}}
                    onSubmit = {(value)=>{
                        console.log(value)
                        updateUser(users.id, value.fullname, value.address, users.image, value.jobTitle, value.vehicle)
                        navigation.goBack() }}
                    >
                    { (props)=>(
                        <View>
